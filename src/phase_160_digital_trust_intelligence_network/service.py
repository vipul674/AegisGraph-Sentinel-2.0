...
from .store import DigitalTrustIntelligenceNetworkStore


class DigitalTrustIntelligenceNetworkService:
    def __init__(self, store: DigitalTrustIntelligenceNetworkStore):
        self.store = store

    def create_record(self, tenant_id: str, record_id: str, name: str,
                       status: str = "ACTIVE", metadata: Dict[str, Any] = None) -> DigitalTrustIntelligenceNetworkRecord:
        record = DigitalTrustIntelligenceNetworkRecord(
            record_id=record_id,
            tenant_id=tenant_id,
            name=name,
            status=status,
        ...
        event = DigitalTrustIntelligenceNetworkEvent(
    ...
    def create_alert(self, tenant_id: str, alert_id: str, title: str,
                     severity: str) -> DigitalTrustIntelligenceNetworkAlert:
        alert = DigitalTrustIntelligenceNetworkAlert(
            alert_id=alert_id,
            tenant_id=tenant_id,
            title=title,
            severity=severity,
...
def get_service() -> DigitalTrustIntelligenceNetworkService:
    from .store import get_store
    return DigitalTrustIntelligenceNetworkService(get_store())
