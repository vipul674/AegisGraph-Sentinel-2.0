...
from src.phase_160_digital_trust_intelligence_network.models import DigitalTrustIntelligenceNetworkRecord, DigitalTrustIntelligenceNetworkEvent, DigitalTrustIntelligenceNetworkAlert
from src.phase_160_digital_trust_intelligence_network.store import DigitalTrustIntelligenceNetworkStore
from src.phase_160_digital_trust_intelligence_network.service import DigitalTrustIntelligenceNetworkService
from src.phase_160_digital_trust_intelligence_network.analytics import DigitalTrustIntelligenceNetworkAnalytics


def test_record_creation():
    store = DigitalTrustIntelligenceNetworkStore()
    svc = DigitalTrustIntelligenceNetworkService(store)
