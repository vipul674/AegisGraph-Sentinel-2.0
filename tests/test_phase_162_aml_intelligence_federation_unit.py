...
from src.phase_162_aml_intelligence_federation.models import AMLIntelligenceFederationRecord, AMLIntelligenceFederationEvent, AMLIntelligenceFederationAlert
from src.phase_162_aml_intelligence_federation.store import AMLIntelligenceFederationStore
from src.phase_162_aml_intelligence_federation.service import AMLIntelligenceFederationService
from src.phase_162_aml_intelligence_federation.analytics import AMLIntelligenceFederationAnalytics


def test_record_creation():
    store = AMLIntelligenceFederationStore()
    svc = AMLIntelligenceFederationService(store)
