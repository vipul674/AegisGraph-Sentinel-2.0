...
from .store import SecurityObservabilityIntelligencePlatformStore


class SecurityObservabilityIntelligencePlatformService:
    def __init__(self, store: SecurityObservabilityIntelligencePlatformStore):
        self.store = store

    def create_record(self, tenant_id: str, record_id: str, name: str,
                       status: str = "ACTIVE", metadata: Dict[str, Any] = None) -> SecurityObservabilityIntelligencePlatformRecord:
        record = SecurityObservabilityIntelligencePlatformRecord(
            record_id=record_id,
            tenant_id=tenant_id,
            name=name,
            status=status,
        ...
        event = SecurityObservabilityIntelligencePlatformEvent(
    ...
    def create_alert(self, tenant_id: str, alert_id: str, title: str,
                     severity: str) -> SecurityObservabilityIntelligencePlatformAlert:
        alert = SecurityObservabilityIntelligencePlatformAlert(
            alert_id=alert_id,
            tenant_id=tenant_id,
            title=title,
            severity=severity,
...
def get_service() -> SecurityObservabilityIntelligencePlatformService:
    from .store import get_store
    return SecurityObservabilityIntelligencePlatformService(get_store())
